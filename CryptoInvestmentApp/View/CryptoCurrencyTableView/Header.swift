...
required init?(coder aDecoder: NSCoder) {
   ...
   weak var delegate: sortDelegate?
    ...
    func setupView() {
        ...
        let spaceScaleAreaOne: CGFloat = 0.185
        ...
        coinNameButton.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: UIScreen.main.bounds.width*spaceScaleAreaOne).isActive = true
        ...
        rateButton.trailingAnchor.constraint(equalTo: self.trailingAnchor).isActive = true
    }
}
